...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
            ...
            if (delimIndex == -1) {
                ...
                if (delimIndex > 0 && template.charAt(delimIndex - 1) == C_BACKSLASH) {
                    if (delimIndex > 1 && template.charAt(delimIndex - 2) == C_BACKSLASH) {
                        ...
                        sbuf.append(Convert.utf8Str(params[argIndex]));
    ...
    public static final String toStr(Object val) {
        if (null == val) {
            return null;
        }
    ...
    public static final Integer toInteger(Object val) {
        if (null == val) {
            return null;
        }
    ...
    public static final Boolean toBoolean(Object val) {
        if (null == val) {
            return null;
        }
        String str = String.valueOf(val);
     ...
     * @return String
     */
    public static String endSeparator(String path) {
        if (isEmpty(path)) {
            return "";
        }
