...
public class HttpUtils {
     ...
     *
     * @param url   发送请求的 URL
     * @param headers 请求头参数，key-value格式
     * @param param 请求参数，请求参数应该是 name1=value1&name2=value2 的形式。
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, Map<String, String> headers, String param, int connectTimeout, int readTimeout) {
        ...
        try {
            ...
            log.error("调用HttpUtils.sendPost Exception, url={},param={}", url, param, e);
        } finally {
            try {
                if (out != null) {
                    out.close();
                ...
                log.error("调用HttpUtils.sendPost in.close Exception, url={},param={}", url, param, ex);
            }
        }
        return result.toString();
    }
    ...
    public static String sendPost(String url, String param) {
        ...
        return sendPost(url, headers, param, DEFAULT_CONNECT_TIMEOUT, DEFAULT_READ_TIMEOUT);
    }
    ...
    public static String sendSSLPost(String url, String param) {
        ...
        try {
            ...
            log.info("sendSSLPostrecv - {}", result);
            conn.disconnect();
            br.close();
        } catch (ConnectException e) {
            ...
            log.error("调用HttpUtils.sendSSLPost Exception, url={},param={}", url, param, e);
        }
        return result.toString();
    }
